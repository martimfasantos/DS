...
savefig(f'images/rf/drought_under_rf_study.png')
show()
...
savefig(f'images/rf/drought_under_rf_best.png')
show()
...
savefig(f'images/rf/drought_under_rf_ranking.png')
...
savefig(f'images/rf/overfitting_drought_under.png')
