...
from matplotlib.pyplot import figure, xticks, show, savefig, subplots
...
week_df['date'] = index.drop_duplicates().to_date()
...
month_df['date'] = index.drop_duplicates().to_date()
...
quarterly_df['date'] = index.drop_duplicates().to_date()
