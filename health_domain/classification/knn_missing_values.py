...
from ds_charts import multiple_line_chart, plot_overfitting_study, plot_evaluation_results_ternary
...
for file in os.listdir(dir_path):
    ...
    if os.path.isfile(os.path.join(dir_path, file)):
        ...
        file_paths.append(f'data/train_and_test/missing_values/{file_name}')
# print(file_paths)
...
for i in range(len(file_names)):
    ...
    savefig(f'../data_preparation/images/missing_values/knn/{file_name}_knn_study.png')
    # show()
    ...
    savefig(f'../data_preparation/images/missing_values/knn/{file_name}_knn_best.png')
    # show()
    ...
    def plot_overfitting_study(xvalues, prd_trn, prd_tst, name, xlabel, ylabel):
        ...
        savefig(f'../data_preparation/images/missing_values/knn/overfitting_{file_name}.png')
