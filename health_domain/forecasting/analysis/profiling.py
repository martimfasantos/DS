...
tight_layout()
# show()
savefig(f'images/profiling/data_dimensionality.png')
...
tight_layout()
# show()
savefig(f'images/profiling/data_granularity_days.png')
...
tight_layout()
# show()
savefig(f'images/profiling/data_granularity_weeks.png')
...
tight_layout()
# show()
savefig(f'images/profiling/data_granularity_months.png')
...
# show()
savefig(f'images/profiling/5-number_summary_table.png')
...
# show()
savefig(f'images/profiling/5-number_summary_boxplot.png')
...
# show()
savefig(f'images/profiling/value_distribution_hourly.png')
...
# show()
savefig(f'images/profiling/value_distribution_weekly.png')
...
# show()
savefig(f'images/profiling/data_stationarity.png')
