...
plot_forecasting_series(train, test, prd_trn, prd_tst, f'{file_name} Simple Average Plots', saveto=f'images/simple_average/{file_tag}_simpleAvg_plots.png', x_label=index_col, y_label=target)