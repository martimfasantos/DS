...
plot_forecasting_series(train, test, prd_trn, prd_tst, 'Glucose Best ARIMA Plots', saveto=f'images/arima/{file_tag}_arima_plots.png', x_label= str(index_col), y_label=str(target))